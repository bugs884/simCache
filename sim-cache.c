		  ...
		  int argc, char **argv)	/* command line arguments */
{
  ...
  if (!mystricmp(cache_il1_opt, "none"))
	...
	fatal("the l1 inst cache must defined if the l2 cache is defined A");
      cache_il2 = NULL;
    }
	...
	fatal("I-cache l1 cannot access D-cache l1 as it's undefined");
      ...
      /* the level 2 I-cache cannot be defined */
 //      if (strcmp(cache_il2_opt, "none"))
	// fatal("the l1 inst cache must defined if the l2 cache is defined B");
 //      cache_il2 = NULL;
    }
	...
	fatal("I-cache l1 cannot access D-cache l2 as it's undefined");
      ...
      /* the level 2 I-cache cannot be defined */
      if (strcmp(cache_il2_opt, "none"))
	fatal("the l1 inst cache must defined if the l2 cache is defined C");
      cache_il2 = NULL;
    }
  else /* il1 is defined */
    {
